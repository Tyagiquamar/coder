...
func TestGetDeploymentWorkspaceAgentStats(t *testing.T) {
	...
	t.Run("Aggregates", func(t *testing.T) {
		...
		vscodeApps, sshApps, jetbrainsApps, rptyApps := dbtestutil.AllFamilyApps()
...
func TestGetDeploymentWorkspaceAgentUsageStats(t *testing.T) {
	...
	t.Run("Aggregates", func(t *testing.T) {
		...
		dbgen.WorkspaceAgentStat(t, db, database.WorkspaceAgentStat{
			...
			RxBytes:                   1,
			ConnectionMedianLatencyMS: 1,
		}, map[string]int64{"ssh": 4, "vscode": 3}) // Should be ignored.
		dbgen.WorkspaceAgentStat(t, db, database.WorkspaceAgentStat{
			CreatedAt: insertTime.Add(-time.Minute),
			AgentID:   agentID,
			Usage:     true,
...
func TestGetWorkspaceAgentUsageStats(t *testing.T) {
	...
	t.Run("Aggregates", func(t *testing.T) {
		...
		dbgen.WorkspaceAgentStat(t, db, database.WorkspaceAgentStat{
			...
			RxBytes:                   2,
			ConnectionMedianLatencyMS: 1,
		}, map[string]int64{"vscode": 3, "ssh": 4}) // Should be ignored.
		dbgen.WorkspaceAgentStat(t, db, database.WorkspaceAgentStat{
			CreatedAt:   insertTime,
			AgentID:     agentID1,
			WorkspaceID: workspaceID1,
...
func TestGetWorkspaceAgentUsageStatsAndLabels(t *testing.T) {
	...
	t.Run("Aggregates", func(t *testing.T) {
		...
		dbgen.WorkspaceAgentStat(t, db, database.WorkspaceAgentStat{
			...
			RxBytes:                   2,
			ConnectionMedianLatencyMS: 1,
		}, map[string]int64{"vscode": 4, "ssh": 3}) // Should be ignored.
		dbgen.WorkspaceAgentStat(t, db, database.WorkspaceAgentStat{
			CreatedAt:   insertTime,
			AgentID:     agent1.ID,
			WorkspaceID: workspace1.ID,
